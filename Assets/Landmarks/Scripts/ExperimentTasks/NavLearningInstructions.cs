...
public class NavLearningInstructions : ExperimentTask {

    /*ASM 2021
     * Specific instructions task for Navigation Learning Paradigm
     * Changes incrementation and message based on threshold of criteria from NavLearningTask.cs
     */
   ...
   // private string[] currentMultiObjects;
    ...
    public override void TASK_START()
    {
        ...
        hud.setMessage("Please navigate from the " + objects.objects[NavLearningSetup.currentStart].name + " to the " + objects.objects[NavLearningSetup.currentTarget].name + ".");//here is where we can set the text
